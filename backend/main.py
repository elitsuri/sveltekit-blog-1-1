...
app = FastAPI(
    title="sveltekit-blog-1",
    description="SvelteKit Blog 1: High-performance blog with SSR, markdown, SEO, and dark mode",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "sveltekit-blog-1"}
